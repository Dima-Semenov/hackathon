...
import { getAllBlogs, getAllBlogsFromApi, getArrayFavotiteFilms, getPages, getSearchFilm, getSortedBy, setNextPage } from '../../redux/slices/blogSlice'
...
const CardsContainer = () => {
  ...
  const renderList = () => {
    return (sortedBy.sortedBy === 'Favorites' ? arrayFavotiteFilms : sortedValue).map(({ id, title, overview, poster_path }) => {
        return (
            <Card
              key={id}
              id={id}
